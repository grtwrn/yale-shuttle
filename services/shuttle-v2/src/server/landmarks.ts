...
export type Landmark = {
  ...
  /**
   * What kind of place this is, in OpenStreetMap's own vocabulary (the tag
   * each entry was verified against is the trailing comment on its line), so
   * a curated place and an OSM search result can share one icon table on the
   * client — see `suggIcon` in web/src/format.ts. A rider scanning a
...
export const LANDMARKS: readonly Landmark[] = [
  // -- Campus areas ----------------------------------------------------------
  { label: "25 Science Park", lat: 41.320867, lon: -72.928993, aliases: ["science park", "yale science park", "science park at yale", "150 munson"], poi: "college", anchorStop: "Canal / Munson" }, // OSM W76235255
  { label: "Cross Campus", lat: 41.310464, lon: -72.92714, aliases: ["xc"], poi: "park", anchorStop: "College / Wall (N)" }, // OSM R5421111
  { label: "Old Campus", lat: 41.308751, lon: -72.928647, aliases: ["durfee's", "durfees", "vanderbilt hall", "lawrance hall", "phelps hall", "welch hall", "bingham hall", "farnam hall", "durfee hall", "connecticut hall", "lanman-wright", "first year", "battell", "battell chapel"], poi: "park", anchorStop: "Phelps Gate" }, // OSM W211737531
  { label: "Undergraduate Admissions (38 Hillhouse)", lat: 41.314572, lon: -72.923772, aliases: ["admissions", "admissions office", "38 hillhouse"], poi: "college", anchorStop: "130 Prospect Street (S)" }, // OSM W225487554
  { label: "West Campus Conference Center", lat: 41.258411, lon: -72.989228, aliases: ["conference center", "wccc"], poi: "college", anchorStop: "Building 800" }, // OSM W364600438
  { label: "Woolsey Hall", lat: 41.311244, lon: -72.926176, aliases: ["woolsey", "memorial hall", "hewitt quadrangle", "beinecke plaza", "sprague hall", "sprague", "morse recital hall"], poi: "college", anchorStop: "College / Wall (S)" }, // OSM W139759935
  { label: "Yale Visitor Center", lat: 41.309212, lon: -72.92566, aliases: ["visitor center", "visitors center", "tours", "campus tour"], poi: "college", anchorStop: "Elm / College" }, // OSM W216863205
  { label: "Yale West Campus", lat: 41.257131, lon: -72.98967, aliases: ["west campus", "wc", "orange campus", "west campus main"], poi: "college", anchorStop: "Building 600" }, // OSM R3861723

  // -- Residential colleges --------------------------------------------------
  { label: "Benjamin Franklin College", lat: 41.314734, lon: -72.925016, aliases: ["franklin", "ben franklin", "bf college", "new colleges", "bf"], poi: "college", anchorStop: "130 Prospect Street (S)" }, // OSM R5424658
  { label: "Berkeley College", lat: 41.311082, lon: -72.927325, aliases: ["berkeley", "bk"], poi: "college", anchorStop: "College / Wall (S)" }, // OSM R6084168
  { label: "Branford College", lat: 41.309671, lon: -72.930083, aliases: ["branford", "harkness tower"], poi: "college", anchorStop: "Library Walk" }, // OSM R2837570
  { label: "Davenport College", lat: 41.310488, lon: -72.931744, aliases: ["davenport", "dport", "dc"], poi: "college", anchorStop: "Elm / York (TYCO)" }, // OSM R2858948
  { label: "Ezra Stiles College", lat: 41.312757, lon: -72.931608, aliases: ["stiles", "ezra stiles", "es"], poi: "college", anchorStop: "Payne Whitney Gym" }, // OSM R5463395
  { label: "Grace Hopper College", lat: 41.309989, lon: -72.92692, aliases: ["hopper", "grace hopper", "gh", "calhoun"], poi: "college", anchorStop: "Elm / College" }, // OSM R2840328
  { label: "Jonathan Edwards College", lat: 41.309041, lon: -72.9299, aliases: ["je", "jonathan edwards"], poi: "college", anchorStop: "Library Walk" }, // OSM W363808899
  { label: "Morse College", lat: 41.312857, lon: -72.929688, aliases: ["morse", "mc"], poi: "college", anchorStop: "Wall / York" }, // OSM R5463394
  { label: "Pauli Murray College", lat: 41.315712, lon: -72.924721, aliases: ["murray", "pauli murray", "pm", "new colleges"], poi: "college", anchorStop: "Prospect / Sachem (S)" }, // OSM R5424657
  { label: "Pierson College", lat: 41.310194, lon: -72.932383, aliases: ["pierson", "pc"], poi: "college", anchorStop: "Library Walk" }, // OSM R5421070
  { label: "Saybrook College", lat: 41.31015, lon: -72.92915, aliases: ["saybrook", "sy"], poi: "college", anchorStop: "Elm / High" }, // OSM R2837571
  { label: "Silliman College", lat: 41.310449, lon: -72.924982, aliases: ["silliman", "sm", "good life center"], poi: "college", anchorStop: "College / Wall (N)" }, // OSM R5405274
  { label: "Timothy Dwight College", lat: 41.310338, lon: -72.923648, aliases: ["td", "timothy dwight"], poi: "college", anchorStop: "Wall / Church" }, // OSM R2868459
  { label: "Trumbull College", lat: 41.310696, lon: -72.929575, aliases: ["trumbull", "tc"], poi: "college", anchorStop: "Elm / York" }, // OSM R3634728
  ...
  // -- Academic buildings ----------------------------------------------------
  { label: "Arthur K. Watson Hall (AKW)", lat: 41.313078, lon: -72.924852, aliases: ["akw", "watson hall", "computer science", "cs department", "51 prospect"], poi: "college", anchorStop: "Becton / 15 Prospect" }, // OSM W217270615
  { label: "Bass Center for Molecular and Structural Biology", lat: 41.318095, lon: -72.921835, aliases: ["bass center", "266 whitney"], poi: "college", anchorStop: "Lot 22 - Whitney / Humphrey" }, // OSM R14221284
  { label: "Becton Center", lat: 41.312672, lon: -72.925125, aliases: ["becton", "ceid", "center for engineering innovation and design", "15 prospect"], poi: "college", anchorStop: "Becton / 15 Prospect" }, // OSM W217270619
  { label: "Dunham Laboratory", lat: 41.312324, lon: -72.92454, aliases: ["dunham", "dunham lab", "seas", "school of engineering", "engineering", "10 hillhouse"], poi: "college", anchorStop: "Becton / 15 Prospect" }, // OSM W217270620
  ...
  { label: "Loria Center", lat: 41.309022, lon: -72.931564, aliases: ["loria", "history of art", "190 york"], poi: "college", anchorStop: "180 York (A&A)" }, // OSM W224889714
  ...
  { label: "Sheffield-Sterling-Strathcona Hall (SSS)", lat: 41.311929, lon: -72.925217, aliases: ["sss", "sheffield sterling strathcona", "1 prospect"], poi: "college", anchorStop: "College / Grove (N)" }, // OSM W217270625
  { label: "Sloane Physics Laboratory", lat: 41.317283, lon: -72.923023, aliases: ["sloane", "spl", "physics", "217 prospect"], poi: "college", anchorStop: "SCL" }, // OSM W228473356
  { label: "Sterling Chemistry Laboratory", lat: 41.318225, lon: -72.922921, aliases: ["scl", "sterling chem", "chemistry", "225 prospect", "kcl", "kline chemistry lab", "kline chemistry laboratory", "chemistry building"], poi: "college", anchorStop: "Chemistry / 225 Prospect" }, // OSM W363820905
  { label: "Watson Center", lat: 41.315616, lon: -72.923559, aliases: ["watson", "60 sachem", "yale watson center"], poi: "college", anchorStop: "Prospect / Sachem (N)" }, // OSM W238532528
  { label: "William L. Harkness Hall (WLH)", lat: 41.310684, lon: -72.926997, aliases: ["wlh", "harkness hall", "100 wall"], poi: "college", anchorStop: "College / Wall (N)" }, // OSM W139420880
  { label: "Wright Laboratory", lat: 41.319018, lon: -72.920743, aliases: ["wright lab", "wnsl", "272 whitney"], poi: "college", anchorStop: "Lot 22 - Whitney / Humphrey" }, // OSM W228473354
  ...
  { label: "School of Medicine (YSM)", lat: 41.303186, lon: -72.933746, aliases: ["med school", "medical school", "ysm", "sterling hall of medicine", "shm", "333 cedar", "medicine", "harkness auditorium (shm)", "harkness auditorium", "harkness memorial auditorium", "mary harkness auditorium", "mary s harkness memorial auditorium", "med school auditorium"], poi: "college", anchorStop: "333 Cedar" }, // OSM W180193233
  ...
  { label: "Aldi / Walmart (Hamden)", lat: 41.37512, lon: -72.91709, aliases: ["aldi", "walmart", "hamden walmart"], poi: "supermarket", anchorStop: "Aldi/Walmart" }, // OSM W630282072
  { label: "Atticus Market", lat: 41.321363, lon: -72.911948, aliases: ["romeo and cesares", "romeos", "romeo & cesare's", "771 orange"], poi: "supermarket", anchorStop: "Orange / Willow (N)" }, // OSM N470706373
  ...
  { label: "Grove Street Cemetery", lat: 41.31335, lon: -72.926841, aliases: ["cemetery", "grove st cemetery"], poi: "park", anchorStop: "Becton / 15 Prospect" }, // OSM W43437557
  { label: "Marsh Botanical Garden", lat: 41.321675, lon: -72.924629, aliases: ["marsh gardens", "botanical garden", "greenhouse"], poi: "park", anchorStop: "Prospect / Hillside" }, // OSM W40783723
  { label: "New Haven Green", lat: 41.308017, lon: -72.927059, aliases: ["the green", "green", "downtown", "bus hub", "ct transit"], poi: "park", anchorStop: "Phelps Gate" }, // OSM R11597767
  { label: "Wooster Square", lat: 41.304758, lon: -72.917775, aliases: ["wooster", "cherry blossoms"], poi: "park", anchorStop: "Court / Olive" }, // OSM W43437030
