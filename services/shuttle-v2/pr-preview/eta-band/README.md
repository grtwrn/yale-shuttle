...
Screenshots for `eta/calibrated-range` (rebased on #224/#225/#230: "Yale Shuttle Tracker" title and tagline) (`web/src/etaBand.ts`, `fmtBusBand`),
...
|---|---|---|
| `moving-toward-layover.png` | `Red   12 (6-20) min · 2 buses   25 min / 11:44a` | #304 driving toward the 344 Winchester layover — a range while MOVING, the operator's first ask; #316 behind it inside the band, so bunching.ts folds the pair |
| `standing-at-layover.png` | `Red   in 4 (2-10), 17 min   17 min / 11:36a` | #304 standing at 344 Winchester: the median beside the band, the second bus apart; the low end is floored at departNow + the shortest stand left (`standingLowFloor`), the low end today's card printed |
