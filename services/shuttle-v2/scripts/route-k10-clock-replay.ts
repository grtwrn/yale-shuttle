...
import { applyRouteK10Trial, ADDITIONAL_K10_MODELS } from '../src/server/routeK10Trial.js';
...
assert(compared>500);assert(active>100);assert(released>100);assert(restarts>20);assert(changed>500);
...
fs.writeFileSync('route-k10-production-audit.json',JSON.stringify(audit,null,2));console.log(JSON.stringify(audit,null,2));
