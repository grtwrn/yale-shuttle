/**
 * The detector as it was BEFORE PR #57 (`git show 83a8d65:.../detector.ts`, imports
 * repointed). Loaded by `jitter-audit.ts DETECTOR=pre57` so #57's effect on the
 * jump tail can be measured with the production clock. Not shipped code.
 */
import { distanceMeters } from "../../src/network/geo.js";
import type { TransitNetwork } from "../../src/network/TransitNetwork.js";
import type { EpochMs } from "../../src/schema/api.js";
