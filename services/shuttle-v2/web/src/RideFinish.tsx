...
export const RideFinish: FC<{
  ...
  return (
    <section aria-label="Finish your trip" style={{
      ...
      <div role="status" style={{ fontSize: 16, fontWeight: 700 }}>{reason ? "Ride tracking stopped" : "Ride ended"}</div>
      {explanation && <p style={{ margin: "8px 0", fontSize: 14, lineHeight: 1.4 }}>{explanation}</p>}
      {hasDestination && <>
