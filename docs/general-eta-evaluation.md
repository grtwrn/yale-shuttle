...
That persistent-client comparison does not validate a complete newly opened Trip: plan-time bus choice, pinned-bus changes, jumps and dropped options require a rider-sequence replay. The [PR 184 review follow-up](pr184-rider-review.md) distinguishes those experiments and checks actual context activation rather than inferring it from payload acceptance.
...
**These confirmation days contain no Red Line observations; there is no held-out Red evidence in this study.** September 5–6 cover weekend service and September 7 has only fifteen post-midnight visits. They support general transfer to other routes, not a separate-day confirmation of weekday Red service.
