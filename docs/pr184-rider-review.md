...
There is **no held-out Red Line validation** in this study. September 4 was used for development. The strong Red Winchester first-total result, 134.86 → 71.17 seconds across 25 visits, comes from the previously inspected September 8 regression cohort. The separate September 5–7 confirmation contains no Red observations. Its component remaining-time MAE was 46.87 → 44.42 seconds, with a descriptive vehicle/day interval of −5.51 to −0.69 seconds for the difference. The September 9 prospective scorer stopped on duplicate rider-query/physical-target keys and produced no validation result.
