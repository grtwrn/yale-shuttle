...
import {computeUpcomingArrivals} from '/home/gwarren/projects/yale-shuttle-watcher/overnight-eta-2026-09-17/services/shuttle-v2/web/src/arrivals.ts';
...
import {registerRoutePaths} from '/home/gwarren/projects/yale-shuttle-watcher/overnight-eta-2026-09-17/services/shuttle-v2/web/src/anchor.ts';
import {applyModelParams} from '/home/gwarren/projects/yale-shuttle-watcher/overnight-eta-2026-09-17/services/shuttle-v2/web/src/eta/params.ts';
...
import {ETA_MAX_AGE_MS} from '/home/gwarren/projects/yale-shuttle-watcher/overnight-eta-2026-09-17/services/shuttle-v2/web/src/etaSource.ts';
import {anchorKeyFor} from '/home/gwarren/projects/yale-shuttle-watcher/overnight-eta-2026-09-17/services/shuttle-v2/web/src/liveAnchor.ts';
...
const arm=process.argv[2];assert.ok(['current','canonical'].includes(arm));
...
for(const line of fs.readFileSync(A+'/release-integration-data/raw-complete-frames.jsonl','utf8').trim().split('\n')){
