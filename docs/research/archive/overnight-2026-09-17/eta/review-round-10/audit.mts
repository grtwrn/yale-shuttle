...
import {reprice as baseline} from '../cycle-10/shell-current.generated.mts';
import {reprice as candidate} from './shell-candidate.generated.mts';
const O=new URL('.',import.meta.url).pathname, A=O+'../';
