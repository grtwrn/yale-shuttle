...
result={'counts':c,'sessions':len(sessions),'cautionField':'journeyArrival.catchRisk','note':'Checks the actual nested journeyArrival.catchRisk field on the new6000:9000 slice; counts above exactly match saved paired decisions. No browser assertion. Initial inherited prefix note was corrected; comparison logic and decisions were unchanged.'};(O/'decision-verification.json').write_text(json.dumps(result,indent=2)+'\n');print(json.dumps(result,indent=2))
