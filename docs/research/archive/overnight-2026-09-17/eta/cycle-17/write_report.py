...
assert sum(n for k,n in s['availability'].items() if k.endswith(':current-only'))==35
assert sum(n for k,n in s['availability'].items() if k.endswith(':canonical-only'))==29
