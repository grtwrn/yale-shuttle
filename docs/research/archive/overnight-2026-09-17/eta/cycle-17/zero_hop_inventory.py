...
meta=json.loads((O/'current-resume6000-meta.json').read_text());selected=collections.defaultdict(list)
...
# This is the new 6000:9000 slice; retain every unresolved zero-hop case without an assumed count.
