...
import {reprice} from '../cycle-4/shell-live.generated.mts';
...
const fd=fs.openSync('/home/gwarren/projects/yale-shuttle-watcher/overnight-2026-09-17/eta/review-round-4/decisions.jsonl','w');
...
fs.writeFileSync('/home/gwarren/projects/yale-shuttle-watcher/overnight-2026-09-17/eta/review-round-4/decision-meta.json',JSON.stringify(meta,null,2)+'\n');console.log(JSON.stringify({...meta,replans:meta.replans.map(({session,n}:any)=>({session,n}))}));
