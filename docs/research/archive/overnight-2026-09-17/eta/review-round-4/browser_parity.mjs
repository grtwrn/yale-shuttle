...
const service=process.cwd(),out='/home/gwarren/projects/yale-shuttle-watcher/overnight-2026-09-17/eta/cycle-4';
 ...
 for(const sid of ['58224:48:0','58224:48:150']){
  ...
  try{
   ...
   for(let i=0;i<timeline.length;i++){
    ...
    }catch(e){await fs.writeFile('/home/gwarren/projects/yale-shuttle-watcher/overnight-2026-09-17/eta/review-round-4/browser-failure.json',JSON.stringify({sid,i,at:active.at,want,arrays:await page.evaluate(()=>window.__parityArrays),text:await page.locator('body').innerText()},null,2));throw e;}
...
}finally{await browser.close();await fs.writeFile('/home/gwarren/projects/yale-shuttle-watcher/overnight-2026-09-17/eta/review-round-4/browser-parity.json',JSON.stringify(report,null,2)+'\n');}
