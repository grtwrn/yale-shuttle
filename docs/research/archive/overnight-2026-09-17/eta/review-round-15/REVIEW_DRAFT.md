Superseded by `../independent-review-round-15.md`; final checks subsequently passed.

# Independent review 15 — cycle-16 measurement correction

Research only. Exact supplied head/base and independently read HEAD/merge-base are `98e535b99649e74ca599d2e33bcfdc46df83d30d`; tree `d0ab5a7678483e956bd1e4072abe92b18a464218`. Candidate, working-tree and index diffs are empty. This is a correction to retrospective measurement, not an estimator proposal or production approval.

The locked replay-label verification passed. The final record-multiset comparison is pending; the final review note will supersede this draft.
...
- Final reproduction comparison — pending.
