  ...
  for opt in d['options']:
   ...
   def resolve():
    ...
    if boarding['source']=='raw-at-stop':
     ...
     eligible=[(i,v) for i,v in enumerate(vs) if v['stop_index']==bmap['idx'] and (i>0 or (same and bmap['firstHop']==0))]
     if len(eligible)<=bmap['occ']:return 'pickup-chain-incomplete'
     bi=eligible[bmap['occ']][0]
