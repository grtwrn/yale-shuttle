...
immediate_step=distance(before,out)
plateau=observed[1789657087861]
assert plateau['lat']==observed[1789657052869]['lat'] and plateau['lon']==observed[1789657052869]['lon']
excursion=distance(plateau,out)
assert 60<immediate_step<70 and 90<excursion<100
report=dict(sourceVisitClocksChecked=9,decisions=38,busPolls=19,postDepartureAtStopHandlerOffsetsSec=after,
    source65347FreshCollectionOffsetsSec=post,preDepartureExcursionFromPlateauMeters=excursion,
    stepFromImmediatelyPreviousCapturedPositionMeters=immediate_step,
