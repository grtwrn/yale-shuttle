...
(Path('/home/gwarren/projects/yale-shuttle-watcher/overnight-2026-09-17/eta/review-round-2/intermediate-raw-audit.json')).write_text(json.dumps(dict(scope='Ten selected intermediate visits; actual recorded coordinates only, no first-published collector-clock claim.',cases=results),indent=2)+'\n')
