...
import {offlineHistoryFit,setOfflineHistoryArm,offlineHistoryAudit} from './history-release.ts';
...
fs.writeFileSync(root+'/red-rest-history-2026-09-18/full-pickup/fold-check.json',JSON.stringify(result,null,2)+'\n');
