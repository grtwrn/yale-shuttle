...
D=pathlib.Path(__file__).resolve().parent;TZ=ZoneInfo('America/New_York');P=D/'final-pairs.jsonl'
db=sqlite3.connect('file:'+str(D/'outcomes-complete.db')+'?mode=ro',uri=True);db.row_factory=sqlite3.Row
