...
let emitted=0,beliefChecks=0,changed=0;const unavailable:any={baseline:0,candidate:0};const gaps:any[]=[];let n=0;
for(const f of frames){
 ...
 for(const arm of arms){
  setSampledFutureLap(arm==='candidate');
