...
Before reading this extension's results, add the original hybrid's disclosed observed-exit sensitivity: also permit a causal current drive from344 or a stage beyond344 to activate the switch when its completed visit record is unavailable. Keep the strict-event arm. This avoids confusing absence of a finalized visit with absence of observed route progress.
