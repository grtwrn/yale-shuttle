...
Separate e778 qualification is now complete in [E778-QUALIFICATION-RESULTS.md](E778-QUALIFICATION-RESULTS.md), implementation 501e5e1, hosted gate 35769507682. A fresh complete served/build proof becomes available at 2026-09-22T18:45:30Z; it does not inherit or backdate the earlier quick verification. The complete e778 web tree is `f985c086ee1d340ab37c7fc7c482b98bcde03ac6`; the previously reported `c86bcf55` identifies only `web/src`. The default stays 05a, and each isolated process requires its explicitly selected source to match the extracted module. Only the two full commit IDs in `source-versions.mjs` are accepted; b008 remains unsupported. The original proof and full-week benchmark are unchanged.
